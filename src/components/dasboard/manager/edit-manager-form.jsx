...
const EditManagerForm = () => {
  ...
  const { currentRecord } = useSelector((state) => state.misc); //cuurentRecorda hangi rowdaysa o row daki tum datalari gondermistik, artik editManegerForm kullanici bilgilerien ulasbilir--> bunlar uzerinde degisklik yapabilcek 
